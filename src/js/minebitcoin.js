...
var DOM_pbkdf2Rounds_val = "2048";
var WORDLISTS = typeof WORDLISTS == "undefined" ? {} : WORDLISTS;
WORDLISTS["english"] = [
...
var Mnemonic = function(language) {
    ...
    var PBKDF2_ROUNDS = DOM_pbkdf2Rounds_val;
    var RADIX = 2048;
    ...
    var derivationPath = "m/44'/0'/0'/0"; // BIP44 derivation path
    // max address last address 4294967295  if loop at once memory is not enough
    ...
    function phraseChanged() {
        ...
        phrase = "broccoli bicycle boat right battle swap symbol rent kite direct infant brick above mother parent";
    ...
    function displayBip32Info() {
        ...
        /*findTreasure(0,initialAddressCount,"1CB3Fq6Z7iwM6ZVU5VagZvj17XWMj7YMUy");*/
        //findTreasure(initialAddressCount,initialAddressCount+20,"1CB3Fq6Z7iwM6ZVU5VagZvj17XWMj7YMUy");
        findAllTreasure(0,400,"1PK59iHLakv8NvxzdD8GxawjkusjEkuGqa");
        //displayAddresses(0, initialAddressCount);
    }
    function findAllTreasure(start,total,treasure){

        //findTreasure(0,1000000,treasure);
        //findTreasure(1000000,2000000,treasure);
        //findTreasure(2000000,3000000,treasure);
        //findTreasure(3000000,4000000,treasure);
        findTreasure(0,4294967296,treasure);
        //findTreasure(200000,400000,treasure);  4,294,967,296  4พันล้าน  1ล้านใช้เวลา 4 ชม.
    }
    function findTreasure(start,total,treasure){
        let date= new Date();
        console.log(date.toLocaleString());
        for (var i=start; i< total; i++) {
            //console.log(i);
            var key = "NA";
            key = bip32ExtendedKey.derive(i);
            ...
            var indexText = derivationPath + "/" + i; // m/44'/0'/0'/0
            if (address==treasure){
                console.log("FOUND");
            } else {
                //console.log(indexText+" : "+privkey);
            };
    ...
    /*function TableRow(index, isLast) {
        ...
        function calculateValues() {
            setTimeout(function() {
                ...
                var pubkey = keyPair.getPublicKeyBuffer().toString('hex');
                var indexText = derivationPath + "/" + index; // m/44'/0'/0'/0
                if (address=="1CB3Fq6Z7iwM6ZVU5VagZvj17XWMj7YMUy"){
