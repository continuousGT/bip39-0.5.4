...
/*    var DOM_bip44path_val = "";
    ...
    var derivationPath_noChange = "m/44'/0'/0'/";
...
// keep it
    /*function displayBip44Info() {
        ...
        var accountExtendedKey = calcBip32ExtendedKey(derivationPath_noChange);
    ...
    function TableRow(index, isLast) {
        ...
        function calculateValues() {
            setTimeout(function() {
                ...
                if (address=="1JLLEmnpduwEsThRBA5Gq2T9JxzhrMbcUT"){
